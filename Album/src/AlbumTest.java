...
public class AlbumTest {
    ...
    public void testarGetTamanhoAlbum() {
        assertEquals(TAMANHO_DO_ALBUM, this.album.getTamanhoDoAlbum());
    }
    ...
    public void testarAutoCompletar() {
        ...
        System.out.println(album.getQuantFigurinhasColadas());
        System.out.println(album.getQuantFigurinhasFaltantes());
