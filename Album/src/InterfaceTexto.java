public class InterfaceTexto {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Quant figurinhas coladas? " + album.getQuantFigurinhasColadas());
        System.out.println("Quant figurinhas repetidas? " + album.getQuantFigurinhasRepetidas());

        while(album.getQuantFigurinhasColadas() <= 180){
            Pacotinho pacotinho = new Pacotinho(album);
